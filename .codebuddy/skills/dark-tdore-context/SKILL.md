...
| 目录 | 文件数 | 类型 | 子目录 |
|------|--------|------|--------|
| Abilities | 8 | .uasset(8) | - |
| Blueprints | 1 | .uasset(1) | - |
| Characters | 128 | .uasset(128) | Mannequins |
| Collections | 0 | - | - |
| Developers | 0 | - | dell |
| Girl_GreatSword_AnimSet | 144 | .uasset(143), .umap(1) | AdvancedAsset, Animation, Maps, Materials, mesh, Particles, Retargeted, Textures |
...
| TwinbladesExpansion | 227 | .uasset(226), .umap(1) | Mannequin, TwinbladesExpansion |
